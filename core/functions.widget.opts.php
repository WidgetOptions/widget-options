...
class PHPBITS_extendedWidgets {
    ...
    function widget_options( $widget, $return, $instance ){
        ...
        <div class="extended-widget-opts-form <?php if( $width < 520 && $width > 370 ){ echo 'extended-widget-opts-form-large'; }else if( $width < 370 ){ echo 'extended-widget-opts-form-small'; }?>">
